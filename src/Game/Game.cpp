...
void Game::Setup() {
    ...
    trunk.addComponent<TransformComponent>(glm::vec2(50.0, 100.0), glm::vec2(1.0, 1.0), 0.0);
    trunk.addComponent<RigidBodyComponent>(glm::vec2(0.0, 50.0));
    trunk.addComponent<SpriteComponent>("truck-image", 32, 32);
}
